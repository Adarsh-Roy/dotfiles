...
```
rm -rf /tmp/dotfiles-setup && git clone -b install-script --depth 1 https://github.com/Adarsh-Roy/dotfiles.git /tmp/dotfiles-setup && bash /tmp/dotfiles-setup/bootstrap.sh ; rm -rf /tmp/dotfiles-setup
```
